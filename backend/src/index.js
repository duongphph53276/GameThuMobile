...
import { AddProduct, ListProduct, EditProduct, DeleteProduct, GetProductById } from './controllers/products.js';
import { Register, Login, VerifyToken, Profile, UpdateProfile } from './controllers/auth.js';
import { AddGameName, DeleteGameName, EditGameName, GetGameNameById, ListGameNames } from './controllers/gamename.js';
import { authMiddleware, restrictTo } from './middleware/auth.js';
import { GetUserById, UserEdit, UserList } from './controllers/user.js';
