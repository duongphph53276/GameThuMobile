...
const GameNameAdd: React.FC = () => {
  ...
  return (
    <div className="max-w-lg mx-auto p-6 bg-white shadow-md rounded-lg">
      <h2 className="text-2xl font-bold mb-6 text-gray-800">Thêm Game Mới</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          ...
          <input
            ...
            className="mt-1 w-full border border-gray-300 p-2 rounded-lg text-gray-900 placeholder-gray-400 focus:ring-blue-500 focus:border-blue-500"
